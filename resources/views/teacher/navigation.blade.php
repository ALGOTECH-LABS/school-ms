...
<body>
	...
	<div class="sidebar">
		...
		<ul class="nav-links">
			...
			<li class="nav-links-li {{ request()->is('teacher/routine') || request()->is('teacher/timetable') || request()->is('teacher/subject') || request()->is('teacher/gradebook') || request()->is('teacher/syllabus') ? 'showMenu':'' }}">
				<div class="iocn-link">
					<a href="#">
						<div class="sidebar_icon">
